...
export default function PropertyDetailsModal({ isOpen, onClose, property }) {
  ...
  return (
    <>
      {/* FIXED: Changed z-40 to z-[100] to sit above headers */}
      <div className="fixed inset-0 bg-black/50 z-[100] flex items-end sm:items-center justify-center">
        <div className="bg-white w-full sm:max-w-lg sm:rounded-2xl max-h-[90vh] overflow-y-auto animate-slide-up">
          ...
          <div className="relative bg-gray-100">
            ...
            <button 
                onClick={onClose} 
                className="absolute top-3 right-3 z-50 bg-white/90 backdrop-blur-sm p-2 rounded-full shadow-lg hover:bg-white transition-colors"
            >
            ...
            {/* Type Badge */}
            <div className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-semibold text-blue-700 shadow-sm">
              {property.type}
            </div>
          </div>
